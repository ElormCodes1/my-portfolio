...
import { siteTagline, socialLinks } from "@/lib/site-data";
import LabStatusBoard from "./LabStatusBoard";
import UrlRecon from "./UrlRecon";
      ...
      <div className="container relative">
        <div className="hero-enter mx-auto max-w-4xl">
          <div className="mb-8 flex flex-wrap items-center gap-4">
            ...
            <LabStatusBoard compact />
          </div>

          <p className="font-mono text-sm text-radar md:text-base">{siteTagline}</p>

          <h1 className="heading-display mt-4 text-4xl leading-[1.1] sm:text-5xl md:text-6xl lg:text-[3.5rem]">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-steel md:text-xl">
            Web scraping, data acquisition, and AI engineering — datasets, APIs,
            and automation for teams that need reliable extraction at scale.
          </p>
        ...
        <div className="mx-auto mt-12 grid max-w-4xl gap-6 lg:grid-cols-[1fr_280px]">
          <div
            className="hero-pipeline-terminal rounded-lg border border-[var(--color-border)] bg-ink-elevated/60 p-4 font-mono text-xs backdrop-blur-sm md:p-5"
            aria-hidden="true"
          >
